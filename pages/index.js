  ...
  return (
    <div className="">
      ...
      <main className='max-w-7xl mx-auto px-8 sm:p-16'>
        ...
        <LargeCard img='https://lnks.papareatc.com/' title='The Greatest Outdoors' description='Wishlists curated by Airbnb' buttonText='Get Inspired'  />
...
export async function getStaticProps() {
  const explorData = await fetch('https://links.papareact.com/pyp').then(res => res.json());
